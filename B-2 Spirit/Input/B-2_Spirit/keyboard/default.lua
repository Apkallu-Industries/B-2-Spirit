...
-- WASD, QE & Altitude Flight Controls
{combos = {{key = 'W'}}, pressed = iCommandThrottleIncrease, up = iCommandThrottleStop, name = _('Throttle Up (Speed) - W'), category = _('Flight Control')},
{combos = {{key = 'S'}}, pressed = iCommandThrottleDecrease, up = iCommandThrottleStop, name = _('Throttle Down (Speed) - S'), category = _('Flight Control')},
{combos = {{key = 'A'}}, down = iCommandPlaneLeftStart, up = iCommandPlaneLeftStop, name = _('Roll Left - A'), category = _('Flight Control')},
{combos = {{key = 'D'}}, down = iCommandPlaneRightStart, up = iCommandPlaneRightStop, name = _('Roll Right - D'), category = _('Flight Control')},
{combos = {{key = 'Q'}}, down = iCommandPlaneLeftRudderStart, up = iCommandPlaneLeftRudderStop, name = _('Rudder Left (Yaw) - Q'), category = _('Flight Control')},
{combos = {{key = 'E'}}, down = iCommandPlaneRightRudderStart, up = iCommandPlaneRightRudderStop, name = _('Rudder Right (Yaw) - E'), category = _('Flight Control')},

-- Altitude Direct Climb & Descend Controls (Punch above / duck below clouds)
{combos = {{key = 'R'}}, down = iCommandPlaneDownStart, up = iCommandPlaneDownStop, name = _('Climb / Pitch Up - R'), category = _('Flight Control')},
{combos = {{key = 'F'}}, down = iCommandPlaneUpStart, up = iCommandPlaneUpStop, name = _('Descend / Pitch Down - F'), category = _('Flight Control')},
{combos = {{key = 'Space'}}, down = iCommandPlaneDownStart, up = iCommandPlaneDownStop, name = _('Climb / Pitch Up - Space'), category = _('Flight Control')},
{combos = {{key = 'C'}}, down = iCommandPlaneUpStart, up = iCommandPlaneUpStop, name = _('Descend / Pitch Down - C'), category = _('Flight Control')},
{combos = {{key = 'Down'}}, down = iCommandPlaneDownStart, up = iCommandPlaneDownStop, name = _('Pitch Up (Climb) - Down Arrow'), category = _('Flight Control')},
{combos = {{key = 'Up'}}, down = iCommandPlaneUpStart, up = iCommandPlaneUpStop, name = _('Pitch Down (Descend) - Up Arrow'), category = _('Flight Control')},
